...
namespace Bunny_Race
{
    public partial class RaceTrack : Form
    {
        ...
        private void PunterRadioButtons()
        {
            ...
            myPunter[2].MyRadioButton.Text = "Mandeep";
        ...
        private void LBLs()
        {
            ...
            myProperty.LBLMandeep = myProperty.NotBetYet;
        }
        ...
        private void PunterNotBetYet()
        {
            ...
            myPunter[2].MyRadioButton = Mandeep_RadioBtn;
            lblMandeep.Text = myPunter[2].PunterName + myProperty.LBLMandeep;
        }
        ...
        private void AmountBetText()
        {
            ...
            {
                lblMandeep.Text = myPunter[2].PunterName + " has bet $" + myPunter[2].AmountBet + " on #" + (myProperty.Bunny) + " " + myBunny[myProperty.BunnyID].Name + ".";
            }
            ...
            for (myProperty.Punter = 0; myProperty.Punter < 3; myProperty.Punter++)
            {
                ...
                else
                {
                    ...
                    if (myPunter[myProperty.Punter].MaxCash == 0)
                    {
                        ...
                        {
                            myProperty.LBLMandeep = myProperty.Busted;
                            lblMandeep.Text = myPunter[2].PunterName + myProperty.LBLMandeep;
                            lblMandeep.ForeColor = Color.Red;
        ...
        {
            if (myProperty.LBLAli == " you have run out of Cash! BUSTED!" && myProperty.LBLJay == " you have run out of Cash! BUSTED!" && myProperty.LBLMandeep == " you have run out of Cash! BUSTED!")
            {
        ...
        private void btnRestart_Click(object sender, EventArgs e)
        {
            ...
            lblMandeep.ForeColor = Color.Black;
